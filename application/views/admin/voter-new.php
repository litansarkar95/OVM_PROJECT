                ...
                <div class="panel-body">
                    <form id="sform" role="form"  name="sform"  method="post" action="<?php echo base_url() ?>voter/insert" enctype="multipart/form-data" onsubmit="return valiform()">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fathername" placeholder="Enter Your Father Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" onClick="multiplyBy1()" name="contact" placeholder="Enter Contact Number">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="<?php echo date("Y-m-d") ?>" name="start_date" id="start-date" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" rows="1" cols="16" id="result4" name="nid"><?php echo set_value("nid"); ?> </textarea>
                        </div>
                        <div class="form-group">
